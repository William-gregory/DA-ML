...
If you would like to test this code, I would recommend using the `EAKF_sequential_singlenode.py` code, which should run on your local machine (may be slow depending on the horizontal grid resolution and number of obs being assimilated).
